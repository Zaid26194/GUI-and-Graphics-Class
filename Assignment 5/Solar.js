...
function render() {
  ...
  var name, planet, data, mercName, venusName, earthName, marsName,
      jupiterName, saturnName, uranusName, neptuneName, plutoName, moonName;
  ...
  mercName = "Mercury";
  planet = Planets[mercName];
  data = SolarSystem[mercName];

  planet.PointMode = false;

  ms.push();
  ms.rotate((1 / data.year) * time, [0, 0, 1]);
  ms.translate(data.distance*compensating, 0, 0);
  ms.scale(data.radius*compensating);
  gl.useProgram(planet.program);
  gl.uniformMatrix4fv(planet.uniforms.MV, false, flatten(ms.current()));
  gl.uniformMatrix4fv(planet.uniforms.P, false, flatten(P));
  gl.uniform4fv(planet.uniforms.color, flatten(data.color));
  ...
  venusName = "Venus";
  planet = Planets[venusName];
  data = SolarSystem[venusName];
  ...
  earthName = "Earth";
  planet = Planets[earthName];
  data = SolarSystem[earthName];
  ...
  moonName = "Moon";
  planet = Planets[moonName];
  data = SolarSystem[moonName];
  ...
  marsName = "Mars";
  planet = Planets[marsName];
  data = SolarSystem[marsName];
  ...
  jupiterName = "Jupiter";
  planet = Planets[jupiterName];
  data = SolarSystem[jupiterName];
  ...
  saturnName = "Saturn";
  planet = Planets[saturnName];
  data = SolarSystem[saturnName];
  ...
  uranusName = "Uranus";
  planet = Planets[uranusName];
  data = SolarSystem[uranusName];
  ...
  neptuneName = "Neptune";
  planet = Planets[neptuneName];
  data = SolarSystem[neptuneName];
  ...
  plutoName = "Pluto";
  planet = Planets[plutoName];
  data = SolarSystem[plutoName];
